...
| ライブラリ               | バージョン | 用途/追加理由 |
| ----------------------- | -------- | ------------- |
| `spring-boot-starter-*` | 1.4.2    | Spring Boot 基盤 (actuator/security/aop/cache/data-jpa/web) |
| `hibernate-*`           | 5.2.4    | DB 永続化サポート (core/java8) |
| `ehcache`               | 3.1.+    | JCache 実装 |
| `HikariCP`              | 2.5.+    | コネクションプーリング実装の組み立て用途 |
| `jackson-datatype-*`    | 2.8.+    | JSON 変換時の Java8 / Hibernate 対応 |
| `eclipse-collections`   | 8.0.0    | コレクションライブラリ |
